                    ...
                    <div class="navbar-nav flex-row order-md-last">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                <a href="{{ url('pegawai/fitur_lainnya/profile') }}" class="dropdown-item">Profile</a>
                                <a href="{{ url('pegawai/fitur_lainnya/ubah_password') }}" class="dropdown-item">Ubah Password</a>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <div class="navbar">
                        <div class="container-xl">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('pegawai/home/home') }}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('pegawai/presensi/rekap_presensi') }}">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
